...
$authType = $_SERVER['AUTH_TYPE'] ?? null;
...
if ($providedUser !== TEST_USER || $providedPassword !== TEST_PASSWORD) {
    ...
    <div class="card">
        ...
        <?php endif; ?>
        <p class="small text-muted">Diagnostic rapide :</p>
        <ul class="small text-muted">
            <li><code>PHP_AUTH_USER</code> = <code><?= htmlspecialchars($_SERVER['PHP_AUTH_USER'] ?? 'null') ?></code></li>
            <li><code>REMOTE_USER</code> = <code><?= htmlspecialchars($_SERVER['REMOTE_USER'] ?? 'null') ?></code></li>
            <li><code>AUTH_TYPE</code> = <code><?= htmlspecialchars($authType ?? 'null') ?></code></li>
        </ul>
    </div>
    </body>
    </html>
